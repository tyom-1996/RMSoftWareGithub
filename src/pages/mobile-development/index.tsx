...
const MobileDevelopment: React.FC = () => {
    ...
    const intro = t("mobileDevelopment.intro", []) as string[];

    const about = t("mobileDevelopment.about", {
        title: "",
        paragraphs: [],
    }) as any;

    const howItWorks = t("mobileDevelopment.howItWorks.items", []) as Array<{
        id: number;
        title: string;
        description: string;
    }>;

    const solution = t("mobileDevelopment.solution", {
        title: "",
        description: "",
        items: [],
    }) as any;

    const whatMakes = t("mobileDevelopment.whatMakes", []) as Array<{
        id: number;
        title: string;
        steps: string[];
    }>;
        ...
        <main className="main_page" id="mobile_development_page">
            ...
            <div className="top_section_header">
                <div>
                    <HomeIcon />
                    <ArrowIcon />
                    <span className="top_section_header_text">{t('mobileDevelopment.breadcrumb')}</span>
                </div>
            </div>
            ...
            <section className="how_it_works_section">
                <div className="how_it_works_section_wrapper">
                    <div className="how_it_works_section_content">
                        <h2 className="how_it_works_section_title">{t('mobileDevelopment.howItWorks.title')}</h2>
                        {howItWorks && (
