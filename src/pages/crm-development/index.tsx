...
const CRMDevelopment: React.FC = () => {
    ...
    const metaTitle = locale === "en" ? "CRM Development — RM Software" : "Vývoj CRM — RM Software";
    const metaDescription =
        locale === "en"
            ? "Custom CRM and workflow systems tailored by RM Software."
            : "Zakázkový vývoj CRM a workflow systémů od RM Software.";

    const advantages = t("crmDevelopment.advantages", []) as Array<{
        id: number;
        img: string;
        title: string;
        description: string;
    ...
    const intro = t("crmDevelopment.intro", []) as string[];

    const about = t("crmDevelopment.about", {
        title: "",
        paragraphs: [],
    }) as any;

    const howItWorks = t("crmDevelopment.howItWorks.items", []) as Array<{
        id: number;
        title: string;
        description: string;
    }>;

    const solution = t("crmDevelopment.solution", {
        title: "",
        description: "",
        items: [],
    }) as any;

    const whatMakes = t("crmDevelopment.whatMakes", []) as Array<{
        id: number;
        title: string;
        steps: string[];
    }>;
        ...
        <main className="main_page" id="crm_development_page">
            ...
            <div className="top_section_header">
                <div>
                    <HomeIcon />
                    <ArrowIcon />
                    <span className="top_section_header_text">{t('crmDevelopment.breadcrumb')}</span>
                </div>
            </div>
            ...
            <section className="how_it_works_section">
                <div className="how_it_works_section_wrapper">
                    <div className="how_it_works_section_content">
                        <h2 className="how_it_works_section_title">{t('crmDevelopment.howItWorks.title')}</h2>
                        {howItWorks && (
                        ...
                        {solution && (() => {
                            ...
                            return (
                                <div className="solution_section_item">
                                    ...
                                    <p className="solution_section_item_description">{solution.description}</p>
                                </div>
                            );
                        })()}
                    </div>
            ...
            <section className="what_makes_smart_section">
                ...
                <div className="what_makes_smart_section_wrapper">
                    <div className="what_makes_smart_section_content">
                        {whatMakes && whatMakes.length > 0 && (
                            <>
                                {whatMakes.map((section) => (
